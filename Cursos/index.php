...
<main class="content">
    <section class="course-grid">
        ...
        <div class="side-info">
            <img src="imagem/logo.png-removebg-preview.png" alt="Logo MLMB Grande" class="large-logo">
            <div class="mlmb-text">MLMB</div>
        </div>
    </section>
...
<footer class="bottom-bar">
    <div class="footer-item">CONHECER</div>
    <div class="footer-item">SER</div>
    <div class="footer-item">CONVIVER</div>
    <div class="footer-item">FAZER</div>
</footer>
